...
class IterativeClosestPointExposed
    : public pcl::IterativeClosestPointWithNormals< PointSource, PointTarget, Scalar > {
 public:
...
// const std::string & pcl::search::Search::PointXYZ::getName() const{return "asasasas";}
...
class IcpOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    //     std::cout << "--------------AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA4---------------" << std::endl;
      for (size_t b = 0; b < batch_size; ++b) {
        ...
        // Run ICP.
        IterativeClosestPointExposed<pcl::PointXYZRGBNormal, pcl::PointXYZRGBNormal> icp;
        // pcl::IterativeClosestPointWithNormals<pcl::PointXYZRGBNormal, pcl::PointXYZRGBNormal> icp ( new pcl::IterativeClosestPointWithNormals<pcl::PointXYZRGBNormal, pcl::PointXYZRGBNormal> () );
        ...
        addNormal( cloud_in_moved, cloud_source_normals );
        addNormal( cloud_target, cloud_target_normals );
        addNormal( cloud_in_moved, cloud_source_trans_normals );
    ...
    // worker_threads.num_threads = 0;
    // std::cout << worker_threads.num_threads << std::endl;
    // std::cout << worker_threads.workers << std::endl;
    // Shard(worker_threads.num_threads, worker_threads.workers, batch_size, cost, do_work);
  }
