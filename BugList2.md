...
1. 下载各个库文件， abseil-cpp | glog | opencv-android-sdk | protobuf | rules-apple | rules-cc| rules-closure | tensorflow
2. 修改 workspace 文件， 例如： 注释掉之前按照网址下载的过程，新增加下载安装包的地址。
            ...
            local_repository(
                name = "org_tensorflow",
                path = "/home/fyl/source_code/mediapipe2/__mediapipe_pkgs/tensorflow-f482488b481a799ca07e7e2d153cf47b8e91a60c"
            )
